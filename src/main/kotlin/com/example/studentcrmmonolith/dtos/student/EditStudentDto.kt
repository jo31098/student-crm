...
data class EditStudentDto(
    ...
    @field:Email(message = "Email is invalid", regexp = "[a-z0-9._%+-]+@[a-z0-9.-]+\\.[a-z]{2,3}")
    val email: String,
    ...
    fun toStudentDto() = StudentDto(id, firstName, lastName, email, courseIds)
}
